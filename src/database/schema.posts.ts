...
import { artworks, collections } from "./schema.artworks";
...
// Junction table for many-to-many relationship between posts and artworks
...
// Junction table for many-to-many relationship between posts and collections
